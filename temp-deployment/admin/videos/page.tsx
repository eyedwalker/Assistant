...
type ProcessingStage = 'fetching' | 'transcript' | 'ai-analysis' | 'saving' | 'complete';
  ...
  const simulateProcessingUpdates = (jobs: ProcessingJob[]) => {
    ...
    const updateInterval = setInterval(() => {
      currentJobs = currentJobs.map(job => {
        ...
        const stages: Array<ProcessingStage> = ['fetching', 'transcript', 'ai-analysis', 'saving', 'complete'];
