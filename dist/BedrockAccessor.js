...
exports.BedrockAccessor = void 0;
...
class BedrockAccessor {
    constructor(config) {
        ...
        const httpHandler = new node_http_handler_1.NodeHttpHandler({
        ...
        const httpHandler1 = new node_http_handler_1.NodeHttpHandler({
            connectionTimeout: 60000,
            socketTimeout: 60000,
            httpAgent: {
                maxSockets: 50,
    ...
    async generateChatResponse(message, context = '', userId, tenantId) {
        try {
...
- If information is not in the context, say "Based on the available information..."`
            ...
            if (this.useApiKey === true && this.apiKey) {
                ...
                const response = await axios_1.default.post(`${this.baseUrl}/model/${this.modelId}/invoke`, requestBody, {
                    headers,
    ...
    async generateStreamingResponse(message, context = '', onChunk, userId, tenantId) {
    ...
    async analyzeImage(imageBase64, prompt = 'What is in this image?') {
    ...
    async checkGuardrailIntervention(response) {
...
exports.BedrockAccessor = BedrockAccessor;
